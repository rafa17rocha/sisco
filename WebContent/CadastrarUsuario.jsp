        ...
        <div class="col-sm-12 col-md-12 main">
          ...
          <form class="form-horizontal" action="controller.do" method="post">
			...
			<div class="form-group">
			  ...
			  <div class="col-md-8">
			  <input name="nome" class="form-control input-md" id="nome" type="text" maxlength="100" required placeholder="Nome e sobrenome">
			  </div>
			</div>
			...
			<div class="form-group">
			  ...
			  <div class="col-md-8">
			  <input name="cpf" class="form-control input-md" id="cpf" type="number" maxlength="11" required placeholder="11 dígitos">
			  </div>
			</div>
			...
			<div class="form-group">
			  ...
			  <div class="col-md-8">
			  <input name="empresa" class="form-control input-md" id="empresa" type="text" placeholder="Sistema Predial">
			  </div>
			</div>
			...
			<div class="col-md-4">
				...
				<input type="text" class="form-control" id="expedienteEntrada" name="expedienteEntrada" value="09:00">
				</div>
			</div>
			<div class="col-md-4">
				<div class="input-group-block clockpicker" data-placement="top" data-align="top" data-autoclose="true">
				<input type="text" class="form-control" id="expedienteSaida" name="expedienteSaida" value="16:00">
				</div>
			</div>
			</div>
			</fieldset>
			...
			<div class="form-group">
			  ...
			  <div class="col-md-8">
			  <input name="usuario" class="form-control input-md" id="usuario" type="text" maxlength="32" required placeholder="Fulano Pereira">
			...
			<div class="form-group">
			  ...
			  <div class="col-md-8">
			    <input name="senha" class="form-control input-md" id="senha" type="password" maxlength="32" required placeholder="">
			...
			<div class="form-group">
			  ...
			  <div class="col-md-4">
			    <button type="submit" class="btn btn-success btn-block" name="command" id="salvar" value="CadastrarUsuario">Salvar</button>
			  </div>
			  <div class="col-md-4">
