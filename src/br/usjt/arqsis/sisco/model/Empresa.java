...
public class Empresa implements Serializable
{
	...
	{
		return "Empresa [getRazaoSocial()=" + getRazaoSocial() + ", getCnpj()=" + getCnpj() + ", getConjunto()="
				+ getConjunto() + ", getHorarioDeFuncionamento()=" + getHorarioDeFuncionamento() + ", getHorarioDoAr()="
				+ getHorarioDoAr() + ", getTemperatura()=" + getTemperatura() + "]";
	}
